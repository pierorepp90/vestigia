...
| `paris` | paris-montmartre | El Bateau-Lavoir real: quién trabajó ahí (Picasso pintó *Las señoritas de Avilá/Avignon* en 1907 en ese edificio exacto), por qué se incendió en 1970, y que la reconstrucción actual ni siquiera ocupa la misma huella que el original |
| `lisboa` | lisboa-alfama | Tras el terremoto de 1755, Lisboa se reconstruyó en cuadrícula estricta (Baixa pombalina) salvo Alfama, que sobrevivió sobre roca firme y conservó su trazado medieval/morisco — contraste cuadrícula vs. laberinto; origen disputado del fado (¿marineros? ¿esclavos liberados? ¿exiliados brasileños?) |
...
Expected: sin coincidencias (si aparece alguna, revisar ese post específico antes de escribir — puede ser una mención de paso sin ser la respuesta del enigma, pero conviene mirarlo).
