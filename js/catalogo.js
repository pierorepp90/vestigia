...
export const RUTAS = [
  {
    ...
    resumen: {
      es: 'Diez paradas entre la Catedral y la Plaça Sant Jaume para leer lo que la piedra del Gótico lleva siglos contando: muralla romana, un puente que no es tan medieval como parece y las huellas de un bombardeo de 1938.',
      en: "Ten stops between the Cathedral and Plaça Sant Jaume to read what the stone of the Gothic Quarter has been telling for centuries: a Roman wall, a bridge that's not as medieval as it looks, and the marks of a 1938 bombing.",
      fr: "Dix étapes entre la cathédrale et la Plaça Sant Jaume pour lire ce que la pierre du quartier gothique raconte depuis des siècles : un mur romain, un pont moins médiéval qu'il n'y paraît, et les traces d'un bombardement de 1938.",
      it: "Dieci tappe tra la Cattedrale e la Plaça Sant Jaume per leggere ciò che la pietra del Gotico racconta da secoli: una cinta romana, un ponte meno medievale di quanto sembri e i segni di un bombardamento del 1938.",
    },
    acertijoMuestra: {
...
export const HISTORIAS = [
  {
    ...
    cierre: {
      es: 'Nada de esto le resta encanto al Gòtic: solo reparte el misterio en más capas de las que parece a primera vista. {ruta1} recorre diez paradas por este mismo barrio, entre piedra romana, judía, gótica de verdad y gótica de 1928, y no avisa de antemano cuál es cuál: eso hay que descubrirlo caminando.',
      en: "None of this makes the Gòtic any less charming: it just spreads the mystery across more layers than it seems to have at first sight. {ruta1} covers ten stops through this same district, moving between Roman stone, Jewish stone, real Gothic and 1928 Gothic, and it never tells you upfront which is which — that's something you have to discover on foot.",
      fr: "Rien de tout cela n'enlève de charme au Gòtic : cela ne fait que répartir le mystère sur davantage de strates qu'il n'y paraît au premier regard. {ruta1} parcourt dix étapes dans ce même quartier, entre pierre romaine, juive, gothique pour de vrai et gothique de 1928, sans jamais annoncer à l'avance laquelle est laquelle : cela, il faut le découvrir en marchant.",
      it: 'Nulla di tutto questo toglie fascino al Gòtic: distribuisce solo il mistero su più strati di quanto sembri a prima vista. {ruta1} attraversa dieci tappe in questo stesso quartiere, tra pietra romana, ebraica, gotica vera e gotica del 1928, senza avvisare in anticipo quale sia quale: questo bisogna scoprirlo camminando.',
    },
  },
  {
    id: 'roma',
