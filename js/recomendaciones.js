...
export const RECOMENDACIONES_POR_RUTA = {
  'barcelona-gotic': {
    ...
    movilidad: {
      ...
      texto: {
        es: 'Metro Jaume I (L4, amarilla), a un par de minutos de la Catedral. Un extra: los jueves por la mañana, la Plaça Nova —el punto de partida— acoge un mercado de antigüedades.',
        en: 'Jaume I metro station (L4, yellow line), a couple of minutes from the Cathedral. A bonus: on Thursday mornings, Plaça Nova — the starting point — hosts an antiques market.',
        fr: "Métro Jaume I (L4, jaune), à quelques minutes de la cathédrale. Un plus : le jeudi matin, la Plaça Nova — le point de départ — accueille un marché aux antiquités.",
        it: 'Metro Jaume I (L4, gialla), a un paio di minuti dalla Cattedrale. Un extra: il giovedì mattina, la Plaça Nova — il punto di partenza — ospita un mercatino dell\'antiquariato.',
      },
